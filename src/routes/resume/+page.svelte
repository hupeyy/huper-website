...
<div class="mt-8 mx-auto px-10 max-w-screen-lg">
    ...
    <p class="mb-2 italic text-sm">B.S. in Computer Science | Minor in Mathematics</p>
    <span class="text-base font-bold">GPA:</span>
    <span class="text-base">3.27/4.0</span>
    <p class="my-2 text-lg font-bold">Relevant Coursework:</p>
    <ul class="list-disc list-inside mb-8 space-y-1">
        <li>COP3530 - Data Structures and Algorithms</li>
        <li>COP4600 - Operating Systems</li>
        <li>CEN4930 - AI for Games and Virtual Environments</li>
        <li>CEN3031 - Software Engineering</li>
        <li>CIS4930 - Multi Modal ML in Python</li>
        <li>CDA3101 - Computer Organization</li>
        <li>CIS4930 - UX Design</li>
    ...
    <p class="mb-2 text-lg font-bold">Libraries / Frameworks:</p>
    <ul class="list-disc list-inside mb-8 space-y-1">
        <li>React</li>
        <li>Svelte</li>
        <li>Astro</li>
    ...
    <p class="mb-2 text-lg font-bold">General:</p>
    <ul class="list-disc list-inside mb-8 space-y-1">
        <li>Git</li>
        <li>Linux</li>
        <li>Figma</li>
